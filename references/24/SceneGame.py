...
class	SceneGame(SceneBasic):
	...
	def	initButtons(s,	screenSize):
		...
		s.numberButton1	=	KButton(center[0]-100, center[0]-100, 60, 60,	s.numberButtonImg,True)
		s.bttn1 = IcnTextBox(center[0]-100, center[0]-100, 60, 60, "#111111111")
		s.numberButton2	=	KButton(center[0]-100, center[0], 60, 60,	s.numberButtonImg,True)
		s.bttn2 = IcnTextBox(center[0]-100, center[0], 60, 60, "#2")
		s.numberButton3	=	KButton(center[1]+100, center[1]+100, 60, 60,	s.numberButtonImg,True)
		s.bttn3 = IcnTextBox(center[1]+100, center[1]+100, 60, 60, "#3")
		s.numberButton4	=	KButton(center[1]+100, center[1], 60, 60,	s.numberButtonImg,True)
		s.bttn4 = IcnTextBox(center[1]+100, center[1], 60, 60, "#4")
